...
class SocialManager extends AbstractManager implements ManagerInterface, SingletonInterface
{
    protected $handledNames = ['article:published_time', 'article:modified_time', 'author', 'fb:admins', 'fb:app_id'];
